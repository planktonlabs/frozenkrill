...
impl KeyVersion {
    ...
    #[inline]
    pub fn from_xkey_str(key: &str) -> Result<KeyVersion, anyhow::Error> {
        let xkey = base58::decode(key)?;
        KeyVersion::from_slice(&xkey[..4]).context("unknown key version")
    }
...
pub trait FromSlip132 {
    ...
    fn from_slip132_str(s: &str) -> Result<Self, anyhow::Error>
    where
        Self: Sized;
}
...
mod test {
    ...
    fn key_version_from_xkey_str() {
        ...
        assert_eq!(
            KeyVersion::from_xkey_str(zpub).expect("to decode xpub"),
    ...
    fn xpub_from_slip132_str() {
        ...
        assert_eq!(Xpub::from_slip132_str(xpub_str).unwrap(), xpub);
        assert_eq!(Xpub::from_slip132_str(ypub_str).unwrap(), xpub);
        assert_eq!(Xpub::from_slip132_str(ypub_multi).unwrap(), xpub);
        assert_eq!(Xpub::from_slip132_str(zpub_str).unwrap(), xpub);
        assert_eq!(Xpub::from_slip132_str(zpub_multi).unwrap(), xpub);
        ...
        assert_eq!(Xpub::from_slip132_str(tpub_str).unwrap(), tpub);
        assert_eq!(Xpub::from_slip132_str(upub_str).unwrap(), tpub);
        assert_eq!(Xpub::from_slip132_str(upub_multi).unwrap(), tpub);
        assert_eq!(Xpub::from_slip132_str(vpub_str).unwrap(), tpub);
        assert_eq!(Xpub::from_slip132_str(vpub_multi).unwrap(), tpub);
    }
    ...
    fn xprv_from_slip132_str() {
        ...
        assert_eq!(Xpriv::from_slip132_str(xprv_str).unwrap(), xprv);
        assert_eq!(Xpriv::from_slip132_str(yprv_str).unwrap(), xprv);
        assert_eq!(Xpriv::from_slip132_str(yprv_multi).unwrap(), xprv);
        assert_eq!(Xpriv::from_slip132_str(zprv_str).unwrap(), xprv);
        assert_eq!(Xpriv::from_slip132_str(zprv_multi).unwrap(), xprv);
        ...
        assert_eq!(Xpriv::from_slip132_str(tprv_str).unwrap(), tprv);
        assert_eq!(Xpriv::from_slip132_str(uprv_str).unwrap(), tprv);
        assert_eq!(Xpriv::from_slip132_str(uprv_multi).unwrap(), tprv);
        assert_eq!(Xpriv::from_slip132_str(vprv_str).unwrap(), tprv);
        assert_eq!(Xpriv::from_slip132_str(vprv_multi).unwrap(), tprv);
    }
