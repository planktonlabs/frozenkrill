...
use self::{
    ...
    generate_single::{
        multisig_interactive_generate_single, singlesig_interactive_generate_single,
    },
    open::{multisig_interactive_open, singlesig_interactive_open},
};

use super::{
    ask_continue_without_a_keyfile, from_public_info_json_path_to_non_duress,
    from_wallet_to_public_info_json_path, keyfiles_elevator_pitch,
};
...
pub(crate) fn interactive(
    ...
    match &actions[action] {
        MainActions::SinglesigCreateNewSingle => singlesig_interactive_generate_single(
            theme,
            term,
            secp,
            rng,
